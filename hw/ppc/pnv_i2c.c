...
static void pnv_i2c_update_irq(PnvI2C *i2c)
{
    ...
    pnv_psi_irq_set(i2c->psi, i2c->psi_irq, i2c->regs[I2C_INTR_COND_REG] != 0);
}
...
static void pnv_i2c_handle_cmd(PnvI2C *i2c, uint64_t val)
{
    ...
    i2c->regs[I2C_RESIDUAL_LEN_REG] =
        SETFIELD(I2C_RESIDUAL_FRONT_END, 0, len_bytes) |
        SETFIELD(I2C_RESIDUAL_BACK_END, 0, len_bytes);
...
static void pnv_i2c_fifo_out(PnvI2C *i2c)
{
    ...
    i2c->regs[I2C_FIFO_REG] = SETFIELD(I2C_FIFO, 0, data);
    pnv_i2c_fifo_update_count(i2c);
    pnv_i2c_backend_update(i2c);
}
...
static void pnv_i2c_reset(void *dev)
{
    ...
    i2c->regs[I2C_STAT_REG] = I2C_STAT_CMD_COMP;
    i2c->regs[I2C_EXTD_STAT_REG] =
        SETFIELD(I2C_EXTD_STAT_FIFO_SIZE, 0, PNV_I2C_FIFO_SIZE) |
        SETFIELD(I2C_EXTD_STAT_I2C_VERSION, 0, 23); /* last version */
...
static Property pnv_i2c_properties[] = {
    ...
    DEFINE_PROP_LINK("psi", PnvI2C, psi, TYPE_PNV_PSI, PnvPsi *),
    DEFINE_PROP_UINT32("psi-irq", PnvI2C, psi_irq, PSIHB9_IRQ_SBE_I2C),
